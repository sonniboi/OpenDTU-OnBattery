...
// OnBattery-Ergaenzung: MPPT-Zuordnung der Kanaele.
// Der MIT-5000-8T meldet ueber RF vier unabhaengige Tracker (je 2 Panel-Eingaenge
// teilen sich einen Tracker), daher genau ein Kanal je MPPT.
...
const channelMetaData_t* MIT_8CH::getChannelMetaData() const
{
    return channelMetaData;
}

uint8_t MIT_8CH::getChannelMetaDataSize() const
{
